...
public class ContractQueryServiceImpl implements ContractQueryService {
    ...
    private static final Pattern CONTRACT_ADDRESS_PATTERN = Pattern.compile("^[0-9a-zA-Z]{40}$");
    ...
    @Override
    public List<?> query2(String contractAddressAsString, String methodSignature, Object... methodInputArgs) {
        ...
        return contractQuery.executeQuery(contractAddress, methodSignature, methodInputArgs);
    }
