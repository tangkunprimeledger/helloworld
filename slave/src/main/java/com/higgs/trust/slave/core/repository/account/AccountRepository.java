...
@Repository @Slf4j public class AccountRepository {
    ...
    public AccountInfo openAccount(OpenAccount openAccount) {
        ...
        DataIdentity dataIdentity = DataIdentityConvert
            .buildDataIdentity(openAccount.getAccountNo(), openAccount.getChainOwner(),
                openAccount.getDataOwner());
     ...
     * @param happenAmount
     */
    public void operationAccountBalance(String accountNo, ChangeDirectionEnum changeDirectionEnum, BigDecimal happenAmount) {
        int r = 0;
