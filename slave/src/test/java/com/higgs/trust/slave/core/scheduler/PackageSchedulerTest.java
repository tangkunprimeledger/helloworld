...
public class PackageSchedulerTest extends BaseTest {
    ...
    @Autowired private PackageScheduler packageScheduler;

    @Autowired private Deque<SignedTransaction> pendingTxQueue;

    @Resource(name = "pendingPack") private BlockingQueue<Package> pendingPack;
