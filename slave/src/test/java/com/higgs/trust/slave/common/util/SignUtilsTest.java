...
public class SignUtilsTest {
    ...
    @Test public void signAndVerifySuccess() throws Exception {
        String signature = Rsa.sign(dataStrToSign, privateKey);
        Rsa.verify(dataStrToSign, signature, pubKey);
    }

    @Test public void signAndVerifyFail() throws Exception {
        String signature = Rsa.sign(dataStrToSign, wrongPrivateKey);
        Rsa.verify(dataStrToSign, signature, pubKey);
    }
