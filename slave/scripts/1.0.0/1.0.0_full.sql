...
IF NOT EXISTS `pending_transaction` (
	...
	`tx_data` json NOT NULL COMMENT 'transaction data',
...
IF NOT EXISTS `transaction` (
	`id` BIGINT (20) NOT NULL AUTO_INCREMENT COMMENT 'id',
	`tx_id` VARCHAR (64) NOT NULL COMMENT 'transaction id',
	`biz_model` json DEFAULT NULL COMMENT 'the save data create the biz',
	...
	`action_datas` json DEFAULT NULL COMMENT 'the action list by json',
...
IF NOT EXISTS `tx_out` (
	...
	`state` json NOT NULL COMMENT 'sate data',
