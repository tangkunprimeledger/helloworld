...
public class DefaultApplicationState implements ApplicationState {
    ...
    @Override public boolean equals(Object obj) {
        if (obj instanceof DefaultApplicationState) {
            ...
            if ((this.messageBatches != null && tState.messageBatches == null) || (this.messageBatches == null
                && tState.messageBatches != null)) {
                //Logger.println(("[DefaultApplicationState] returing FALSE1!");
                return false;
            }
            ...
            if (this.messageBatches != null && tState.messageBatches != null) {
                ...
                if (this.messageBatches.length != tState.messageBatches.length) {
                    //Logger.println(("[DefaultApplicationState] returing FALSE2!");
                    return false;
                }
                ...
                for (int i = 0; i < this.messageBatches.length; i++) {
                    ...
                    if (this.messageBatches[i] == null && tState.messageBatches[i] != null) {
                        //Logger.println(("[DefaultApplicationState] returing FALSE3!");
                        return false;
                    }

                    if (this.messageBatches[i] != null && tState.messageBatches[i] == null) {
                        //Logger.println(("[DefaultApplicationState] returing FALSE4!");
                        return false;
                    }

                    if (!(this.messageBatches[i] == null && tState.messageBatches[i] == null)
                        && (!this.messageBatches[i].equals(tState.messageBatches[i]))) {
                        //Logger.println(("[DefaultApplicationState] returing FALSE5!" + (this.messageBatches[i] == null) + " " + (tState.messageBatches[i] == null));
                        return false;
                    }
                }
            }
        ...
        //Logger.println(("[DefaultApplicationState] returing FALSE!");
        return false;
    }
