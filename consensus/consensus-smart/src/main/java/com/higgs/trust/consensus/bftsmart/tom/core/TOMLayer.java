 ...
 * the License.
 */
package com.higgs.trust.consensus.bftsmart.tom.core;

import com.higgs.trust.consensus.bftsmart.clientsmanagement.ClientsManager;
import com.higgs.trust.consensus.bftsmart.clientsmanagement.RequestList;
import com.higgs.trust.consensus.bftsmart.communication.ServerCommunicationSystem;
import com.higgs.trust.consensus.bftsmart.communication.client.RequestReceiver;
import com.higgs.trust.consensus.bftsmart.consensus.Consensus;
import com.higgs.trust.consensus.bftsmart.consensus.Decision;
import com.higgs.trust.consensus.bftsmart.consensus.Epoch;
...
import com.higgs.trust.consensus.bftsmart.statemanagement.StateManager;
import com.higgs.trust.consensus.bftsmart.tom.ServiceReplica;
import com.higgs.trust.consensus.bftsmart.tom.core.messages.ForwardedMessage;
...
import com.higgs.trust.consensus.bftsmart.tom.leaderchange.RequestsTimer;
import com.higgs.trust.consensus.bftsmart.tom.server.Recoverable;
import com.higgs.trust.consensus.bftsmart.tom.server.RequestVerifier;
import com.higgs.trust.consensus.bftsmart.tom.util.BatchBuilder;
import com.higgs.trust.consensus.bftsmart.tom.util.BatchReader;
import com.higgs.trust.consensus.bftsmart.tom.util.Logger;
...
public final class TOMLayer extends Thread implements RequestReceiver {
    ...
    public void run() {
        ...
        while (doWork) {
            ...
            System.out.println("Next leader for CID=" + (getLastExec() + 1) + ": " + execManager.getCurrentLeader());
            //******* EDUARDO BEGIN **************//
            ...
            if (getInExec() != -1) { //there is some consensus running
                ...
                System.out.println("(TOMLayer.run) Waiting for consensus " + getInExec() + " termination.");
                canPropose.awaitUninterruptibly();
            }
            proposeLock.unlock();
