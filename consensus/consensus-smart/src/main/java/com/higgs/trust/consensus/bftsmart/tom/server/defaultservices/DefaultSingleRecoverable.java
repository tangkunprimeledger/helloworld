...
import com.higgs.trust.consensus.bftsmart.tom.server.SingleExecutable;
...
public abstract class DefaultSingleRecoverable implements Recoverable, SingleExecutable {
    ...
    public int setState(ApplicationState recvState) {
        ...
        if (recvState instanceof DefaultApplicationState) {
            ...
            com.higgs.trust.consensus.bftsmart.tom.util.Logger.println("(DefaultSingleRecoverable.setState) I'm going to update myself from CID "
