 ...
 */
package com.higgs.trust.consensus.bftsmart.tom.server.defaultservices.durability;

import com.higgs.trust.consensus.bftsmart.reconfiguration.util.TOMConfiguration;
import com.higgs.trust.consensus.bftsmart.statemanagement.ApplicationState;
import com.higgs.trust.consensus.bftsmart.statemanagement.StateManager;
import com.higgs.trust.consensus.bftsmart.statemanagement.strategy.durability.CSTRequest;
import com.higgs.trust.consensus.bftsmart.statemanagement.strategy.durability.CSTState;
import com.higgs.trust.consensus.bftsmart.statemanagement.strategy.durability.DurableStateManager;
import com.higgs.trust.consensus.bftsmart.tom.MessageContext;
import com.higgs.trust.consensus.bftsmart.tom.ReplicaContext;
import com.higgs.trust.consensus.bftsmart.tom.server.BatchExecutable;
import com.higgs.trust.consensus.bftsmart.tom.server.Recoverable;
import com.higgs.trust.consensus.bftsmart.tom.server.defaultservices.CommandsInfo;
...
public abstract class DurabilityCoordinator implements Recoverable, BatchExecutable {
	...
	public int setState(ApplicationState recvState) {
		...
		if (recvState instanceof CSTState) {
			...
			com.higgs.trust.consensus.bftsmart.tom.util.Logger.println("(DurabilityCoordinator.setState) I'm going to update myself from CID "
			...
			for (int cid = lastCheckpointCID + 1; cid <= lastCID; cid++) {
				try {
					com.higgs.trust.consensus.bftsmart.tom.util.Logger.println("(DurabilityCoordinator.setState) interpreting and verifying batched requests for CID " + cid);
