 ...
 * the License.
 */
package com.higgs.trust.consensus.bftsmart.tom.server.defaultservices;
...
import com.higgs.trust.consensus.bftsmart.statemanagement.strategy.StandardStateManager;
...
public abstract class DefaultRecoverable implements Recoverable, BatchExecutable {
    ...
    private byte[][] executeBatch(byte[][] commands, MessageContext[] msgCtxs, boolean noop) {
        ...
        if (checkpointIndex == -1) {
            ...
            System.out.println("checkpointIndex : " + checkpointIndex);
...
//        if (ret == null) ret = new DefaultApplicationState();
    ...
    public int setState(ApplicationState recvState) {
        ...
        if (recvState instanceof DefaultApplicationState) {
            ...
            com.higgs.trust.consensus.bftsmart.tom.util.Logger.println("(DefaultRecoverable.setState) I'm going to update myself from CID "
                    + lastCheckpointCID + " to CID " + lastCID);
            ...
            for (int cid = lastCheckpointCID + 1; cid <= lastCID; cid++) {
                try {
                    ...
                    com.higgs.trust.consensus.bftsmart.tom.util.Logger.println("(DefaultRecoverable.setState) interpreting and verifying batched requests for cid " + cid);
