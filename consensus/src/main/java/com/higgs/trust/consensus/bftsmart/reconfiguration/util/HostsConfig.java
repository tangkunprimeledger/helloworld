...
public class HostsConfig {
    ...
    private com.higgs.trust.consensus.bftsmart.started.config.SmartConfig config;
    ...
    public HostsConfig(String configHome, String fileName) {
        config = SpringUtil.getBean(com.higgs.trust.consensus.bftsmart.started.config.SmartConfig.class);
