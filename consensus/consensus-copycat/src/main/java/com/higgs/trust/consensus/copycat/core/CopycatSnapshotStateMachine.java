...
@Slf4j public class CopycatSnapshotStateMachine extends StateMachine implements Snapshottable {

    private AbstractCommitReplicateComposite commitReplicate;

    private ConsensusSnapshot snapshot;

    public CopycatSnapshotStateMachine(AbstractCommitReplicateComposite commitReplicate, ConsensusSnapshot snapshot) {
