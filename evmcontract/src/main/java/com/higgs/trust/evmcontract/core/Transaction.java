...
import com.higgs.trust.evmcontract.util.*;
...
public class Transaction {
    ...
    public static final MemSizeEstimator<Transaction> MemEstimator = tx ->
            MemSizeEstimator.ByteArrayEstimator.estimateSize(tx.hash) +
                    MemSizeEstimator.ByteArrayEstimator.estimateSize(tx.nonce) +
                    MemSizeEstimator.ByteArrayEstimator.estimateSize(tx.value) +
                    MemSizeEstimator.ByteArrayEstimator.estimateSize(tx.gasPrice) +
                    MemSizeEstimator.ByteArrayEstimator.estimateSize(tx.gasLimit) +
                    MemSizeEstimator.ByteArrayEstimator.estimateSize(tx.data) +
                    MemSizeEstimator.ByteArrayEstimator.estimateSize(tx.sendAddress) +
                    MemSizeEstimator.ByteArrayEstimator.estimateSize(tx.rlpEncoded) +
                    MemSizeEstimator.ByteArrayEstimator.estimateSize(tx.rawHash) +
