...
public class Sha256Hash implements Serializable, Comparable<Sha256Hash> {
     ...
     * {@link #hashTwice(byte[])}.
     *
     * @param input1  the first hash
     * @param offset1 the offset of the first hash
     * @param length1 the length of the first hash
     * @param input2  the second hash
     * @param offset2 the offset of the second hash
     * @param length2 the length of the second hash
