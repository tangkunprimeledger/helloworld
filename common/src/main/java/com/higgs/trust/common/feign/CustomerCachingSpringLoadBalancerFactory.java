...
//////////////////////////////////////////////////
// copy from CachingSpringLoadBalancerFactory   //
//////////////////////////////////////////////////
public class CustomerCachingSpringLoadBalancerFactory {
	...
	private volatile Map<String, CustomerFeignLoadBalancer> cache = new ConcurrentReferenceHashMap<>();

	public CustomerCachingSpringLoadBalancerFactory(SpringClientFactory factory) {
	...
	public CustomerCachingSpringLoadBalancerFactory(SpringClientFactory factory, LoadBalancedRetryPolicyFactory loadBalancedRetryPolicyFactory,
											LoadBalancedBackOffPolicyFactory loadBalancedBackOffPolicyFactory,
...
//		this.enableRetry = true;
	...
	// customize change                   //
	////////////////////////////////////////
	public CustomerFeignLoadBalancer create(String clientName) {
		...
		CustomerFeignLoadBalancer
            client = enableRetry ? new CustomerRetryableFeignLoadBalancer(lb, config, serverIntrospector,
			loadBalancedRetryPolicyFactory, loadBalancedBackOffPolicyFactory, loadBalancedRetryListenerFactory) : new CustomerFeignLoadBalancer(lb, config, serverIntrospector);
