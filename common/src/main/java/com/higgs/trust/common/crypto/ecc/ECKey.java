 ...
 * </p>
 */
@Slf4j @Component public class ECKey {
    /**
     ...
     * be painfully slow.
     */
    @VisibleForTesting public static boolean FAKE_SIGNATURES = false;
     ...
     * you want {@link ECKey.ECDSASignature#toASN1()}
     ...
     * you want
     * {@link ECKey.ECDSASignature#encodeToDER()}
     * instead. However sometimes the independent components can be useful, for
    ...
    protected ECDSASignature doSign(Sha256Hash input, BigInteger privateKeyForSigning) {
        if (Secp256k1Context.isEnabled()) {
            try {
                byte[] signature =
                    NativeSecp256k1.sign(input.getBytes(), CryptoUtils.bigIntegerToBytes(privateKeyForSigning, 32));
    ...
    @Override public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof ECKey))
            return false;
        ECKey other = (ECKey)o;
        return Objects.equal(this.priv, other.priv) && Objects.equal(this.pub, other.pub) && Objects
            .equal(this.creationTimeSeconds, other.creationTimeSeconds) && Objects
            .equal(this.keyCrypter, other.keyCrypter) && Objects
            .equal(this.encryptedPrivateKey, other.encryptedPrivateKey);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        log.info("公钥:{}", keyPair.getPubKey());
        log.info("私钥:{}", keyPair.getPriKey());
